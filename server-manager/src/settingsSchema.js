...
const serverSettings = [
  ...
  { key: 'adminRoleIds',    label: 'Admin Discord roles', type: 'json', group: 'Advanced', help: 'Discord role ids (strings) whose holders get the in-game admin menu and the server console.' },
