...
export declare function isPickupableItem(formId: number): boolean;
export declare function setCollision(refrFormId: number, collision: boolean): void;

export interface CellEnvironmentDebugData {
  winningCellPlugin: string | null;
  xcll: string | null;
  ltmp: string | null;
  ltmpInheritanceFlags: string | null;
  imgs: string | null;
  clmt: string | null;
  xclr: string | null;
  xclm: string | null;
...
export declare function getCellEnvironmentDebugData(cellFormId: number): CellEnvironmentDebugData | null;
